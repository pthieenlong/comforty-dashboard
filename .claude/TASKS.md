...
### CRM extension (Sprint 9d/9e — gộp trong feat/marketing-crm umbrella)
...
- [ ] `/crm/inquiries` — list + reply (defer Sprint 10 hoặc 11)
- [ ] Activity log timeline trong customer detail (defer Sprint 11)
